...
class Data extends DbConnection
{
	...
	public function login($username, $password)
	{
		...
		try {
			...
			$res = $this->db->prepare('SELECT departamento,id,nome,email,foto,id_perfil_permission,funcao,telefone,email,numero_funcionario FROM utilizador WHERE username=:username AND password=:password AND estado=1');
